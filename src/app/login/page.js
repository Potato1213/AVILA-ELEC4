...
function Login() {
  ...
  const backgroundImage = '/img/uclmloginbackground.png'; // Correct path to your background image
        ...
        <Container maxWidth="xs" sx={{
          ...
          <Box component="form" noValidate sx={{ mt: 1 }}>
            ...
            <FormControlLabel
              ...
              sx={{ color: '#333', fontWeight: 500 }} // Darkened the text and made it bolder
            />
            <Button
              type="submit"
              fullWidth
            ...
            <Box sx={{ display: 'flex', justifyContent: 'space-between', mt: 2 }}>
              ...
              <Link href="#" variant="body2" sx={{ color: '#1976d2', ':hover': { textDecoration: 'underline' } }}>
                Forgot Password?
              </Link>
            </Box>
            <Typography variant="body2" color="textSecondary" align="center" sx={{ mt: 5 }}>
              © EVENTSHPERE {new Date().getFullYear()}
            </Typography>
          </Box>
        </Container>
      </Box>
